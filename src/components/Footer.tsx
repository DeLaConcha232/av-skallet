...
const translations = {
  es: {
    description: 'Desarrolladora de software especializada en soluciones elegantes y escalables.',
  ...
  en: {
    description: 'Software development specializing in elegant and scalable solutions.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="space-y-2">
            <button onClick={() => scrollToSection('#home')} className="flex items-center">
              <img src="/Logotipo_Blanco.png" alt="AV-skallet Logo" className="w-52 h-auto object-contain" />
            </button>
