...
const translations = {
  es: {
    ...
    subtitle:
      "Atendemos necesidades tecnológicas con soluciones robustas y escalables. Siempre adaptadas a tu realidad de negocio.",
    learnMore: "Saber más",
    services: [
      {
        icon: Code,
  ...
  en: {
    title: "Our services",
    subtitle:
      "We address technology needs with robust and scalable solutions. Always adapted to your business reality.",
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Comprehensive consulting for organizations and businesses.",
      },
      {
        icon: Zap,
...
export const Services: React.FC = () => {
  ...
  return (
    <section
      id="services"
      className="relative z-20 border section-padding overflow-hidden"
    >
      {/* Background */}
      ...
      <div className="section-container relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl sm:text-4xl font-display mb-4 text-foreground">
            {t.title}
          </h2>
